...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1713736616932.6504";
}
var buttonVariants = cva("inline-flex items-center justify-center rounded-md text-sm font-medium outline-none ring-ring ring-offset-2 ring-offset-background transition-colors focus-within:ring-2 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50", {
  variants: {
    variant: {
...
var Button = React.forwardRef(_c = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Comp, { ref, className: cn(buttonVariants({
    variant,
    size,
    className
  })), ...props }, void 0, false, {
...
//# sourceMappingURL=/build/_shared/chunk-6RG3S7SV.js.map
